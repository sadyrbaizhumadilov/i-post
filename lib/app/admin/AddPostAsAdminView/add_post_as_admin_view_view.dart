...
import 'package:i_post/app/data/status_service.dart';
import 'package:image_picker/image_picker.dart';


class AddPostAsAdmin extends StatefulWidget {
  const AddPostAsAdmin({Key? key}) : super(key: key);

  @override
  _AddPostAsAdminState createState() => _AddPostAsAdminState();
}

class _AddPostAsAdminState extends State<AddPostAsAdmin> {
